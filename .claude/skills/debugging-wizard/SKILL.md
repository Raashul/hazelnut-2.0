...
dotnet run --launch-profile Development # use Development launchSettings

# Attach dotnet-trace to a running API process
dotnet-trace collect --process-id <pid> --output trace.nettrace

# Capture a memory dump for post-mortem analysis
dotnet-dump collect --process-id <pid>
dotnet-dump analyze core_<pid>
# > clrstack       — managed call stack
# > printexception — current exception details
# > dumpheap -stat — heap object summary
